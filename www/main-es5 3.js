...
var routes = [
    ...
    // Stuff held over from the tutorial. Might be worth a look for future stuff so I left it.
    {
        ...
        children: [
            {
                path: 'feed',
                loadChildren: function () { return Promise.all(/*! import() | pages-feed-feed-module */[__webpack_require__.e("common"), __webpack_require__.e("pages-feed-feed-module")]).then(__webpack_require__.bind(null, /*! ./pages/feed/feed.module */ "./src/app/pages/feed/feed.module.ts")).then(function (m) { return m.FeedPageModule; }); }
            },
            {
                path: 'gym-creation',
                loadChildren: function () { return __webpack_require__.e(/*! import() | pages-gym-creation-gym-creation-module */ "pages-gym-creation-gym-creation-module").then(__webpack_require__.bind(null, /*! ./pages/gym-creation/gym-creation.module */ "./src/app/pages/gym-creation/gym-creation.module.ts")).then(function (m) { return m.GymCreationPageModule; }); }
            },
            {
                path: 'friends',
...
var AutomaticLoginGuard = /** @class */ (function () {
    function AutomaticLoginGuard(router, auth) {
        this.router = router;
        this.auth = auth;
    }
    AutomaticLoginGuard.prototype.canActivate = function (route) {
        var _this = this;
    ...
    AutomaticLoginGuard.ctorParameters = function () { return [
...
var RoleGuard = /** @class */ (function () {
    function RoleGuard(router, auth) {
        this.router = router;
        this.auth = auth;
    }
    ...
    AuthService.prototype.signIn = function (credentials) {
        ...
        return Object(rxjs__WEBPACK_IMPORTED_MODULE_5__["from"])(this.afAuth.auth.signInWithEmailAndPassword(credentials.email, credentials.password)).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["switchMap"])(function (user) {
            ...
            if (user) {
                ...
                console.log(_this.db.doc("users/" + user.user.uid).valueChanges());
                return _this.db.doc("users/" + user.user.uid).valueChanges();
            }
            else {
