...
let GymListingsPageRoutingModule = class GymListingsPageRoutingModule {
};
...
let GymListingsPageModule = class GymListingsPageModule {
};
...
let GymListingsPage = class GymListingsPage {
    constructor(auth, postCrudService, afAuth, storage) {
        this.auth = auth;
...
GymListingsPage.ctorParameters = () => [
...
//# sourceMappingURL=pages-gymListings-gymlistings-module-es2015.js.map