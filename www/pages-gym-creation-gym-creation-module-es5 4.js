...
var GymCreationPageRoutingModule = /** @class */ (function () {
    function GymCreationPageRoutingModule() {
    }
    ...
    return GymCreationPageRoutingModule;
}());
...
var GymCreationPageModule = /** @class */ (function () {
    function GymCreationPageModule() {
    }
...
var GymCreationPage = /** @class */ (function () {
    function GymCreationPage(afAuth, fb, authService, gymService, loadingCtrl, toastCtrl, alertCtrl, router) {
        this.afAuth = afAuth;
        this.fb = fb;
    ...
    GymCreationPage.prototype.ngOnInit = function () {
    ...
    GymCreationPage.prototype.navigateByName = function (name) {
        if (name !== undefined) {
    ...
    //   })
    // }
    GymCreationPage.prototype.register = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        _a.sent();
                        this.gymService.createGym(this.registerForm.value).then(function (res) { return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](_this, void 0, void 0, function () {
                            var toast;
                            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                                switch (_a.label) {
    ...
    GymCreationPage.ctorParameters = function () { return [
...
var GymService = /** @class */ (function () {
    function GymService(db) {
        this.db = db;
    }
    GymService.prototype.createGym = function (credentials) {
        console.log('Create Gym Credentials: ' + credentials);
        return this.db.collection('gyms').add(credentials);
    };
    GymService.prototype.createGymPosts = function (record) {
        return this.db.collection('gyposts').add(record);
    };
    GymService.prototype.readGymPosts = function () {
        return this.db.collection('gymposts').snapshotChanges();
    };
    GymService.prototype.updateGymPost = function (recordID, record) {
        this.db.doc('gymposts/' + recordID).update(record);
    };
    GymService.prototype.deleteGymPost = function (recordId) {
        this.db.doc('gymposts/' + recordId).delete();
    };
    GymService.ctorParameters = function () { return [
...
//# sourceMappingURL=pages-gym-creation-gym-creation-module-es5.js.map