...
let GymAdminPage = class GymAdminPage {
    constructor(auth, db, afAuth, storage, camera, sanitizer, actionSheetController, webview, postCrudService, gymPostCrudService) {
        this.auth = auth;
        this.db = db;
        this.afAuth = afAuth;
    ...
    getMembers() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            const id = '9WkemgxIr047EjC8y7C5';
            yield this.gymPostCrudService.readMemberIds(id).subscribe(data => {
...
let GymPostCrudService = class GymPostCrudService {
    constructor(db) {
        this.db = db;
    }
...
GymPostCrudService.ctorParameters = () => [
